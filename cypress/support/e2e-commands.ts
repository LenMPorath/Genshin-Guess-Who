...
export const LayoutFunctions = {
    fourStarSliderIsEnabled: () => LayoutComponents.fourStarSlider().should('have.attr', 'aria-checked', 'true'),
    fourStarSliderIsntEnabled: () => LayoutComponents.fourStarSlider().should('not.have.attr', 'aria-checked', 'true'),
    fiveStarSliderIsEnabled: () => LayoutComponents.fiveStarSlider().should('have.attr', 'aria-checked', 'true'),
    fiveStarSliderIsntEnabled: () => LayoutComponents.fiveStarSlider().should('not.have.attr', 'aria-checked', 'true'),
    hideMarkedSliderIsEnabled: () => LayoutComponents.hideMarkedSlider().should('have.attr', 'aria-checked', 'true'),
    hideMarkedSliderIsntEnabled: () => LayoutComponents.hideMarkedSlider().should('not.have.attr', 'aria-checked', 'true'),
...
export const CharacterFunctions = {
    ...
    nthCharacterTileIsMarked: (n: number) => CharacterComponents.characterTile().eq(n).should('have.class', 'opacity-50'),
    nthCharacterTileIsntMarked: (n: number) => CharacterComponents.characterTile().eq(n).should('not.have.class', 'opacity-50'),
};
